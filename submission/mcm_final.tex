...
The graph $G(V, E)$ for Male College Basketball have 64 nodes, 134 edges, and 1 weakly connected component. Compared to Basketball and Football, this dataset is considerably smaller, the top five coaches are:

\begin{center}
\begin{tabular}{ | c | c | c| c | }
\hline
Coach Name       & Vote \% \\\hline
Ed Cheff         & 0.02280 \\\hline
Mike Martin      & 0.01829 \\\hline
Gene Stephenson  & 0.01730 \\\hline
Augie Garrido    & 0.01682 \\\hline
Gordie Gillespie & 0.01664 \\
\hline
\end{tabular}
\end{center}

\noindent If we plot the Vote \% of all the coaches from high to low, we can get the following histogram for College Basketball. Similar graphs were computed for Baseball and Football.
