...
Rather than a model that required we arbitrarily modify our graph, we decided it would be best to create a model that relied entirely on the structure of the graph.
