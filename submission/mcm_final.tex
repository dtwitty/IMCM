...
In this paper we employ mathematical models, specifically a combination of graphical and machine learning models, to identify the ``all-time greatest male college coach'' of the last century in the last century for basketball, football, and baseball. Since "best" is ambiguous, we employ a more
 qualitative approach to assessing our models' ranked coach lists through a combination of popular polls and general consensus.
